...
const BACKUP_KEYS = [
  ...
  'searchEngine', 'terminalPlaceholder',
  'bookmarks', 'shelfBookmarks', 'syntaxColors', 'searchOverrides', 'customTags',
  'userBaseFont', 'userMonoFont', 'userBaseFontCustom', 'userMonoFontCustom',
  'userHideInfo', 'userBlockCursor', 'userFrameEnabled', 'userFrameRadius',
  'userFrameColor', 'userThemeBgColor', 'userThemeTextColor'
];
